...
The psoftbeat monitor uses the [psoftjmx](https://github.com/cfazzini/psoftjmx) library that provides a fast concurrent loader of JMX metrics from all PeopleSoft target types.

See releases for current packaged deployment ready to be used.

Steps for running the beat are on the wiki page https://github.com/cfazzini/psoftbeat/wiki/Implementing-the-psoftbeat-on-the-ElasticSearch-and-Kibana
